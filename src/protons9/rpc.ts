import { decodeMessage, encodeMessage, MaxLengthError, message, streamMessage } from 'protons-runtime7'
import type { Codec, DecodeOptions } from 'protons-runtime7'
...
export namespace RPC {
  ...
  export namespace SubOpts {
    ...
    export function encode (obj: Partial<SubOpts>): Uint8Array<ArrayBuffer> {
  ...
  export namespace ControlMessage {
    ...
    export function encode (obj: Partial<ControlMessage>): Uint8Array<ArrayBuffer> {
  ...
  export namespace ControlIHave {
    ...
    export function encode (obj: Partial<ControlIHave>): Uint8Array<ArrayBuffer> {
  ...
  export namespace ControlIWant {
    ...
    export function encode (obj: Partial<ControlIWant>): Uint8Array<ArrayBuffer> {
  ...
  export namespace ControlGraft {
    ...
    export function encode (obj: Partial<ControlGraft>): Uint8Array<ArrayBuffer> {
  ...
  export namespace ControlPrune {
    ...
    export function encode (obj: Partial<ControlPrune>): Uint8Array<ArrayBuffer> {
  ...
  export function encode (obj: Partial<RPC>): Uint8Array<ArrayBuffer> {
